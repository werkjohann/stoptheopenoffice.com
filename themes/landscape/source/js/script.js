(function($) {
// Search
var $searchWrap = $('#search-form-wrap'), isSearchAnim = false,
...
$('body')
    ...
    .on('click', '.article-share-box-link', function(e) {
      ...
      window.open(
          this.href, 'article-share-box-window-' + Date.now(),
...
// Mobile nav
var $container = $('#container'), isMobileNavAnim = false,
